        ...
        <div class="col-sm-5 p-3 cRound" style="border: 1px solid #e9ecef; max-width:500px">
            <div class="d-flex align-items-center justify-content-center flex-wrap gap-4 my-3">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="firstName">By Employee Id</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="filter" id="employeeNo">
                    <label class="form-check-label" for="employeeNo">By Phone No</label>
                </div>
            </div>
            <div>
                <h6>Custom Phone Numbers</h6>
                <textarea id="address" name="address" class="form-control textArea mb-3" rows="3" placeholder="Type phone numbers here..."></textarea>
                <button id="addNumbersButton" class="btn btn-success w-100">Add Numbers</button>
            </div>
            ...
            <form id="fileUploadForm">
                <div class="input-group mb-3 d-flex align-items-center">
                    ...
                    <button id="uploadBtn" class="btn btn-success" style="border-radius: 5px; background-color:#007BFF">Upload</button>
                </div>
